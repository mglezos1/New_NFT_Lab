...
contract('RFT', async addresses =>{
    ...
    it('should work', async() =>{
        ...
        const balanceShareBuyer1 = rft.balanceOf(buyer1);
        const balanceShareBuyer2 = rft.balanceOf(buyer2);
        const balanceShareBuyer3 = rft.balanceOf(buyer3);
        const balanceShareBuyer4 = rft.balanceOf(buyer4);
